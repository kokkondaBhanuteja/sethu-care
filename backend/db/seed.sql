...
INSERT INTO users (id, phone, name, role) VALUES
  ('c1000000-0000-4000-8000-000000000001', '+919000100001', 'Ravi Chandra',  'TECHNICIAN'),
  ('c1000000-0000-4000-8000-000000000002', '+919000100002', 'Sunil Goud',    'TECHNICIAN'),
  ('c1000000-0000-4000-8000-000000000003', '+919000100003', 'Imran Shaik',   'TECHNICIAN'),
  ('c1000000-0000-4000-8000-000000000004', '+919000100004', 'Lakshmi Devi',  'TECHNICIAN'),
  ('c1000000-0000-4000-8000-000000000005', '+919000100005', 'Venkat Rao',    'TECHNICIAN')
ON CONFLICT DO NOTHING;
...
INSERT INTO technicians (user_id, city, is_online, shift_start_minute, shift_end_minute,
  ...
  ('c1000000-0000-4000-8000-000000000001', 'Kompally',     true,  0, 1440, 2, 17.5453, 78.4855, now()),
  ('c1000000-0000-4000-8000-000000000002', 'Madhapur',     true,  0, 1440, 2, 17.4483, 78.3915, now()),
  ('c1000000-0000-4000-8000-000000000003', 'Gachibowli',   true,  0, 1440, 2, 17.4401, 78.3489, now() - interval '45 minutes'),
  ('c1000000-0000-4000-8000-000000000004', 'Kukatpally',   false, 0, 1440, 2, NULL, NULL, NULL),
  ('c1000000-0000-4000-8000-000000000005', 'Secunderabad', false, 0, 1440, 2, NULL, NULL, NULL)
ON CONFLICT (user_id) DO NOTHING;
...
INSERT INTO skills (id, code, name) VALUES
  ('c2000000-0000-4000-8000-000000000001', 'AC_REPAIR',  'AC Repair'),
  ('c2000000-0000-4000-8000-000000000002', 'ELECTRICAL', 'Electrical'),
  ('c2000000-0000-4000-8000-000000000003', 'PLUMBING',   'Plumbing')
ON CONFLICT DO NOTHING;
...
INSERT INTO technician_skills (technician_id, skill_id) VALUES
  ...
  ('c1000000-0000-4000-8000-000000000003', 'c2000000-0000-4000-8000-000000000003'),
  ('c1000000-0000-4000-8000-000000000004', 'c2000000-0000-4000-8000-000000000001'),
  ('c1000000-0000-4000-8000-000000000005', 'c2000000-0000-4000-8000-000000000003')
ON CONFLICT DO NOTHING;
...
INSERT INTO provider_applications
  ...
  ('c3000000-0000-4000-8000-000000000001', 'Anand Joshi', '+919000200001', 'anand@example.in',
   '12 Kompally Main Rd', 'Kompally', 'pending', 3, now() - interval '1 day', now() - interval '30 hours', NULL, ''),
  ('c3000000-0000-4000-8000-000000000002', 'Bhavna Rao', '+919000200002', 'bhavna@example.in',
   '4 Ayyappa Society', 'Madhapur', 'pending', 3, NULL, now() - interval '3 days', NULL, ''),
  ('c3000000-0000-4000-8000-000000000003', 'Chetan Naik', '+919000200003', 'chetan@example.in',
...
INSERT INTO provider_application_categories (application_id, name, years_claimed) VALUES
  ('c3000000-0000-4000-8000-000000000001', 'AC Repair', 5),
  ('c3000000-0000-4000-8000-000000000001', 'Electrical', 2),
  ('c3000000-0000-4000-8000-000000000002', 'Plumbing', 3),
  ('c3000000-0000-4000-8000-000000000003', 'Electrical', 6)
ON CONFLICT DO NOTHING;
...
INSERT INTO provider_application_documents
  ...
  ('c3000000-0000-4000-8000-000000000001', 'AADHAAR',             'validated', now() - interval '30 hours', now() + interval '3 years', '', '', ''),
  ('c3000000-0000-4000-8000-000000000001', 'PAN',                 'validated', now() - interval '30 hours', NULL, '', 'ABCDE1234F', 'ABCDE1234F'),
  ('c3000000-0000-4000-8000-000000000001', 'POLICE_VERIFICATION', 'validated', now() - interval '28 hours', now() + interval '1 year', '', '', ''),
  -- Bhavna: police verification never filed — approval is blocked, server-side.
  ('c3000000-0000-4000-8000-000000000002', 'AADHAAR',             'validated', now() - interval '3 days', now() + interval '2 years', '', '', ''),
  ('c3000000-0000-4000-8000-000000000002', 'PAN',                 'failed',    now() - interval '3 days', NULL, '', 'BXYZQ0000Z', 'BXYZK0001Z'),
  ('c3000000-0000-4000-8000-000000000002', 'POLICE_VERIFICATION', 'missing',   NULL, NULL, '', '', ''),
  -- Chetan: passbook was requested and is still missing.
  ('c3000000-0000-4000-8000-000000000003', 'AADHAAR',             'validated', now() - interval '6 days', now() + interval '4 years', '', '', ''),
  ('c3000000-0000-4000-8000-000000000003', 'ELECTRICAL_CERTIFICATE', 'validated', now() - interval '6 days', now() + interval '2 years', 'Cert IE-2231', '', ''),
  ('c3000000-0000-4000-8000-000000000003', 'POLICE_VERIFICATION', 'validated', now() - interval '5 days', now() + interval '1 year', '', '', ''),
  ('c3000000-0000-4000-8000-000000000003', 'BANK_PASSBOOK',       'missing',   NULL, NULL, '', '', '')
ON CONFLICT DO NOTHING;
