...
## Responsibilities
- `RegisterConsumers` — the single list of event reactions (auto-search, dual-OTP issuance, billing, credits, notifications, ratings).
...
## Contains
- `ConsumerDeps{Notifications, Ops, Verification, Ledger, Identity, FailedCredit, DevEchoOTP, Logger}`.
