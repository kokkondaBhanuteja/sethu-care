          ...
          <div className="flex flex-col gap-s4">
            <div>
              ...
              <h2 className="mt-s2 mb-0 text-section text-text-1">
                {/* The title goes somewhere, so it says so: hover underline + the trailing
                    chevron, the app's reference link language (TableActionLink). */}
                <Link
                  className="inline-flex items-center gap-s1 text-text-1 no-underline hover:underline focus-visible:ring-ring rounded-sm focus-visible:ring-2 focus-visible:outline-none"
