...
curl localhost:8090/health   # {"status":"UP","db":"UP"}
```
...
frontend/           pnpm + Turborepo workspace (see frontend/ for its own commands)
  apps/             landing (Next.js + GSAP) · customer / provider / admin (Vite + Capacitor)
  packages/         tokens · api-client (GENERATED) · domain · i18n · core
```
